...
densenet_weights_path = model_path + "resnet50_weights_tf_dim_ordering_tf_kernels.h5"
...
"""Using DenseNet121 from keras applications"""
...
def predict_and_save(valid_res, test_res, epoch):
    ...
    for th in threshold:
        ...
        th_pred = (test_res > th).astype(int)
        classify(
            th_pred, test_img_names, f"e-{epoch}-threshold-{th}-classification.csv"
        )
