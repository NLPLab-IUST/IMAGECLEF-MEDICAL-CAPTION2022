...
resnet_weights_path = model_path + "/resnet101_weights_tf_dim_ordering_tf_kernels.h5"
...
fine_tuned_resnet = tf.keras.models.Model(inputs=resnet.input, outputs=prediction_layer)
